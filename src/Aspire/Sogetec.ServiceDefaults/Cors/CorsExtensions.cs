...
namespace Sogetec.ServiceDefaults.Cors;
    ...
    extension(IHostApplicationBuilder builder)
    {
        ...
        public void AddDefaultCors()
        {
            ...
            if (builder.Environment.IsDevelopment())
            {
                ...
                {
                    options.AddPolicy(
                        name: CorsConstants.AllowAllCorsPolicy,
            ...
            else
            {
                ...
                {
                    options.AddPolicy(
                        name: CorsConstants.AllowSpecificCorsPolicy,
                        configurePolicy: policyBuilder =>
                        {
                            policyBuilder
                            ...
                            {
                                policyBuilder.SetPreflightMaxAge(TimeSpan.FromSeconds(corsSettings.MaxAge.Value));
                            }
